  ...
  <div class="row align-items-center no-gutters mb-4 mb-lg-5">
    ...
    <div class="col-xl-5 col-lg-5">
      <div class="featured-text text-center text-lg-left">
        ...
        <p class="mb-0 text-black-60">Organizer: {props.exercise.organizer}</p>
        <p class="mb-0 text-black-60">Date: {props.exercise.date.substring(0, 10)}</p>
        <p class="mb-0 text-black-60">Detail: {props.exercise.detail}</p>
        <br />
        <Link class="btn btn-primary js-scroll-trigger" to="/user">
          สมัครวิ่ง
        </Link>
      </div>
    </div>
